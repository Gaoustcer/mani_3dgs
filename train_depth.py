...
from gaussian_renderer_depth import render, network_gui
import sys
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        # cam 'world_view_transform' 4x4 in which the left up 3x3 matrix is R 'projection_matrix' 4x4 camera_center [3] 
        # Render
        ...
        loss = (1.0 - opt.lambda_dssim) * Ll1 + opt.lambda_dssim * (1.0 - ssim(image * mask, gt_image * mask)) + depth_loss
        # loss = depth_loss
        loss.backward()
